...
class LoginPage {
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            // Ejecutar login con indicador; mínimo visible pequeño para evitar parpadeos
            const result = await showLoaderDuring(
                Auth.login(email, password),
                'Verificando credenciales...',
                'solid',
                500 // reducir tiempo mínimo para que feedback sea más rápido
            );
